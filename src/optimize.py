            ...
            while iterations * batch_size < num_examples:
                ...
                if should_print:
                    ...
                    if slow:
                        ...
                        res = saver.save(sess, save_path + '/' + filename + '.ckpt')
                        saver.restore(sess, save_path + '/' +filename + '.ckpt')

                        generate_pb(save_path, filename, tf.device('/cpu:0'), batch_shape, sess)

                    yield _preds, losses, iterations, epoch
    generate_mlmodel(save_path, filename)
...
def generate_mlmodel(ckpt_dir, filename):
